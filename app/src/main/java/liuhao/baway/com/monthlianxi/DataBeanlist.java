...
public class DataBeanlist  {
    ...
    public static class DataBean {
        ...
        public static class ListBean {
            ...
            private boolean isChildGroupCheck = false;

            public boolean isChildGroupCheck() {
                return isChildGroupCheck;
            }

            public void setChildGroupCheck(boolean childGroupCheck) {
                isChildGroupCheck = childGroupCheck;
            }
